...
export const APP_CONFIG = {
  ...
  changelog: {
    ...
    items: [
      ...
      "Modalità Hardcore più scurrile, senza musica continua",
      "Transizioni e micro-interazioni più fluide con movimento ridotto automatico",
      "Anteprime social contenute correttamente in ogni formato",
      "Username stabile: primo cambio gratis, poi 200 Bit",
